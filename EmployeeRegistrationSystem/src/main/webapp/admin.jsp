...
<body>
	...
	<script>
    fetch("http://localhost:8080/EmployeeRegistrationSystem/login")
    .then((res)=>{
        return res.json()
    })
    .then((array)=>{
        ...
        array.forEach(items=> {
            ...
            nametd.textContent  = items.name
            tr.append(nametd);
            
            let emailtd = document.createElement("td");
            emailtd.textContent = items.email;
            tr.append(emailtd);
            
            let gendertd = document.createElement("td");
            gendertd.textContent = items.gender;
            tr.append(gendertd);
